...
Section /o "Sony Ericsson X10 miniドライバ" SEC20
  SetOutPath "$TEMP\Flashtool\ADB\Sony Ericsson X10 mini Drivers"
  File /r "Drivers\ADB\Sony Ericsson X10 mini Drivers\*"
SectionEnd

Section /o "Sony Ericsson Xperia arc, Xperia neo, Xperia PLAY, Xperia acro IS11S, Xperia acro SO-02Cドライバ" SEC21
...
Section /o "Xperia pro, Xperia ray, Xperia ray SO-03Cドライバ" SEC28
...
Section /o "Xperia Sドライバ(ICS向け)" SEC29
...
Section /o "Xperia Tablet Zドライバ SGP311, SGP312, UsbD" SEC37
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC01} "全Xperia共通のFlashModeドライバです。"
  !insertmacro MUI_DESCRIPTION_TEXT ${SEC02} "全Xperia共通のFastBoot modeドライバです。"
